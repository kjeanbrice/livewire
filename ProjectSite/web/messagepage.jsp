                                    ...
                                    <div class="middle_box">
                                        ...
                                        <div class="feed_form" >
                                            <form action="" id="frmpost" method="post">   
                                                    <div class="row_ele">
                                                      <div class="form-group">
                                                <input type="text" name="receiver" id="receiver" tabindex="1" class="form-control" placeholder="To:" value="${requestScope.invaliduser.email}">
                                            </div>
                                            <div class="form-group">
                                                <input type="text" name="subject" id="subject" tabindex="2" class="form-control" placeholder="Subject">
                                            </div>
                                                    </div>  
                                                <div class="row_ele">
                                                    <div class="form-group">
                                                    <textarea name="message" id="message" class="form-control" style="resize: none;" rows="3" placeholder="Message..."></textarea>
                                                    </div>
                                                    </div>  
                                                <div class="row_ele">
                                                    <input class="btn btn-primary" id="btnsend" type="button" name="send" value="Send"/>
...
<script src = "scripts/message_page_transactions.js"></script>
